                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 mb-20">
                    ...
                    <div className="space-y-8">
                        ...
                        <p className="text-sm leading-relaxed max-w-xs">
                            ...
                            Built for accuracy, transparency, and speed across 195+ nations.
                        </p>
                    ...
                    <div className="space-y-8">
                        ...
                        <div className="grid grid-cols-2 gap-x-4 gap-y-3 text-xs font-bold uppercase transition-all">
                            <Link href="/us" className="hover:text-amber-500 hover:translate-x-1 transition-all">United States</Link>
                            <Link href="/india" className="hover:text-amber-500 hover:translate-x-1 transition-all">India</Link>
                            <Link href="/mexico" className="hover:text-amber-500 hover:translate-x-1 transition-all">Mexico</Link>
                            <Link href="/ireland" className="hover:text-amber-500 hover:translate-x-1 transition-all">Ireland</Link>
                            <Link href="/uk" className="hover:text-amber-500 hover:translate-x-1 transition-all">United Kingdom</Link>
                            <Link href="/canada" className="hover:text-amber-500 hover:translate-x-1 transition-all">Canada</Link>
                            <Link href="/australia" className="hover:text-amber-500 hover:translate-x-1 transition-all">Australia</Link>
                            <Link href="/romania" className="hover:text-amber-500 hover:translate-x-1 transition-all">Romania</Link>
                        </div>
                    </div>
                    ...
                    <div className="space-y-8">
                        ...
                        <p className="text-sm">Stay informed about new jurisdictional laws and blog posts.</p>
                        <div className="p-1 bg-slate-900 border border-slate-800 rounded-2xl flex">
                            <input 
                                type="email" 
                                placeholder="Enter your email" 
                                className="bg-transparent border-none outline-none px-4 py-2 flex-grow text-xs font-bold text-white placeholder:text-slate-600"
                            />
                            <button className="bg-amber-600 text-white p-2.5 rounded-xl hover:scale-105 transition-transform">
                                <Send className="w-4 h-4" />
                            </button>
                        </div>
                        <div className="pt-4 flex items-center gap-4 text-xs font-bold text-slate-600 tracking-widest uppercase">
                ...
                <div className="pt-12 border-t border-slate-900 flex flex-col md:flex-row items-center justify-between gap-8">
                    <div className="flex flex-col gap-2">
                        ...
                        <p className="text-[10px] font-black uppercase tracking-[0.3em] opacity-40">
                            © 2026 Legal Check global hub • jurisdictional intelligence engine • v4.2
                        </p>
                    </div>
                    <div className="flex items-center gap-6 text-[10px] font-black uppercase tracking-[0.2em]">
                        <Link href="/about" className="hover:text-amber-500 transition-colors">About Team</Link>
                        <Link href="/contact" className="hover:text-amber-500 transition-colors">Contact Center</Link>
                        <Link href="/#faq" className="hover:text-amber-500 transition-colors">Resource FAQ</Link>
                    </div>
                </div>
            </div>
        </footer>
