...
export const Footer = () => {
    return (
        <footer className="relative bg-slate-950 dark:bg-black pt-20 pb-8 overflow-hidden font-inter text-slate-400">
            {/* Background Accent */}
            ...
            <div className="max-w-7xl mx-auto px-6 relative z-10">
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12 lg:gap-16 mb-20">
                    ...
                    <div className="space-y-6">
                        <Link href="/" className="flex items-center gap-3">
                            ...
                            <span className="font-outfit font-medium text-xl text-white tracking-tighter italic">
                    ...
                    <div className="space-y-6">
                        <h4 className="text-white font-medium text-sm uppercase tracking-[0.2em]">Calculator Hub</h4>
                        <div className="grid grid-cols-2 gap-x-4 gap-y-3 text-[11px] font-medium uppercase">
                    ...
                    <div className="space-y-6">
                        <h4 className="text-white font-medium text-sm uppercase tracking-[0.2em]">Legal Framework</h4>
                    ...
                    {/* Newsletter Column */}
                    <div className="space-y-6">
                        <h4 className="text-white font-medium text-sm uppercase tracking-[0.2em]">Weekly Updates</h4>
                        <div className="flex flex-col gap-3">
                            <div className="p-1 bg-slate-900 border border-slate-800 rounded-2xl flex items-center">
                                <input 
                                    type="email" 
                                    placeholder="Enter your email" 
                                    className="bg-transparent border-none outline-none px-4 py-2 flex-grow min-w-0 text-xs font-medium text-white placeholder:text-slate-600"
                                />
                        ...
                        <div className="pt-2 flex items-center gap-4 text-[10px] font-medium text-slate-700 tracking-[0.2em] uppercase">
                ...
                <div className="pt-12 border-t border-slate-900 flex flex-col md:flex-row items-center justify-between gap-10">
                    ...
                    <div className="flex flex-wrap justify-center md:justify-end gap-6 md:gap-8 text-[10px] font-medium uppercase tracking-[0.2em]">
